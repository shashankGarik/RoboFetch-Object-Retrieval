...
class ArucoGrasper(object):
    ...
    def follow_aruco(self,y,z):
        print('following aruco')
        ...
        if self.aruco_flag == 0:
            ...
            if abs(z) < stopping_dist:
                        
                print('Stopping PID, switching to grasp aruco function')        
                ...
                command.linear.x = k1*z - 0.3
                command.linear.y = 0.0
                command.linear.z = 0.0
                command.angular.x = 0.0 
                command.angular.y = 0.0
                command.angular.z = k2*y
    ...
    # def moveto_aruco(self, aruco_name="target_object"):
    def moveto_aruco(self, aruco_name="unknown"):
        ...
        if self.aruco_found == 0:
            ...
            for i in range(-3, 5):
                ...
                for marker in self.markers:
                    ...
                    if marker.text == aruco_name:
                        ...
                        aruco_position_z = marker.pose.position.z
                        aruco_position_y = marker.pose.position.y

                        self.aruco_found = 1000000000000000000
            ...
            for marker in self.mouth_markers:
                ...
                # if self.mouth_markers[0].type == self.mouth_marker_type:
                    ...
                    self.follow_aruco(self.y, self.z)
    ...
    def grasp_aruco(self, aruco_name="target_object"):
        ...
        if self.do_once == 1 and self.aruco_flag == 1:
            ...
            for i in range(-3, 5):
                ...
                for marker in self.markers:
                    ...
                    if marker.text == aruco_name:
                        ...
                        delta_forward_m = fingers_error[0] + 0.2
                        delta_extension_m = fingers_error[1]
                        delta_lift_m = fingers_error[2]

                        max_lift_m = 1.0
                        lift_goal_m = delta_lift_m + 0.3
