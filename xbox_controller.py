...
def manage_head(robot,controller_state):
    ...
    if not use_head_mapping:
        return
    head_pan_rad = np.deg2rad(40.0)  # 25.0 #40.0
    ...
    # Head tilt
    head_tilt_rad = np.deg2rad(40.0)  # 25.0 #40.0
...
def manage_end_of_arm(robot,controller_state):
    ...
    wrist_yaw_rotate_rad = np.deg2rad(25.0)  # 60.0 #10.0 #5.0
    ...
    wrist_roll_rotate_rad = np.deg2rad(25.0)  # 60.0 #10.0 #5.0
    ...
    wrist_pitch_rotate_rad = np.deg2rad(25.0)  # 60.0 #10.0 #5.0
